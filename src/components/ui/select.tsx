  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:border-org-accent-ring focus-visible:ring-org-accent-ring/35",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "data-highlighted:bg-org-accent-selected data-highlighted:text-org-accent-selected-foreground data-highlighted:**:text-org-accent-selected-foreground",
        className
      )}
      {...props}
    >
