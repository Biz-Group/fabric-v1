      ...
      <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto sm:max-w-sm">
        ...
        {mode !== "delete" && (
          <div className="space-y-3 py-2">
            <div>
              <label htmlFor="crud-name" className="sr-only">
                {entityType} name
              </label>
              <Input
                id="crud-name"
            ...
            {showLocation && (
              <div>
                <p id="crud-location-label" className="mb-1.5 text-sm font-medium text-foreground">
                ...
                >
                  <SelectTrigger
                    className="w-full"
                    aria-labelledby="crud-location-label"
                  >
                    <SelectValue
